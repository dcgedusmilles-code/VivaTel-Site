...
export const metadata: Metadata = {
  title: "Infraestrutura Digital e Inovação em Angola | Blog VIVATEL",
  description:
    "Insights, artigos e análises sobre infraestrutura digital soberana, cloud, segurança, inovação tecnológica e transformação digital em Angola.",
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  Infraestrutura Digital Soberana: o Pilar da Transformação Tecnológica em Angola
                </h2>
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg">
                    A transformação digital é hoje um dos principais motores de desenvolvimento económico e social.
                    Em Angola, investir numa infraestrutura digital soberana, segura e resiliente é essencial para
                    garantir crescimento sustentável, inovação local e competitividade global.
                  </p>
                  ...
                  <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg">
                    A infraestrutura digital vai muito além da conectividade. Ela envolve centros de dados,
                    computação em nuvem, cibersegurança, gestão inteligente de dados e capacitação de talentos.
                    Na VIVATEL, acreditamos que a soberania digital é a base para um ecossistema tecnológico
                    forte, independente e preparado para o futuro.
                  </p>
                  ...
                  <h3 className="font-xl mb-10 leading-tight font-bold text-black sm:text-2xl dark:text-white">
                    Cloud, Segurança e Dados como Fundamentos do Futuro Digital
                  </h3>
                  {/* <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  ...
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    <li className="mb-2 text-base font-medium sm:text-lg">
                      Infraestrutura digital segura e escalável
                    </li>
                    <li className="mb-2 text-base font-medium sm:text-lg">
                      Adoção estratégica de cloud e IA
                    </li>
                    <li className="mb-2 text-base font-medium sm:text-lg">
                      Proteção de dados e soberania nacional
                    </li>
                    <li className="mb-2 text-base font-medium sm:text-lg">
                      Formação e capacitação de talento local
                    </li>
                  </ul>
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-body-color text-center text-base font-medium italic">
                      “A soberania digital não é apenas uma escolha tecnológica,
                      é uma decisão estratégica para o futuro económico e social de Angola.”
                    </p>
                  ...
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg">
                    A VIVATEL posiciona-se como um parceiro estratégico na construção de um ecossistema
                    digital moderno, seguro e sustentável, conectando governo, empresas e cidadãos
                    a soluções tecnológicas de classe mundial.
                  </p>
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text="Infraestrutura Digital" />
                        <TagButton text="Cloud & Segurança" />
                        <TagButton text="Transformação Digital" />
                      </div>
                    </div>
                    <div className="mb-5">
                      <h5 className="text-body-color mb-3 text-sm font-medium sm:text-right">
                        Fale com a VIVATEL e descubra como podemos acelerar a sua transformação digital.
                      </h5>
